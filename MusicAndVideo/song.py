...
async def song(client, message: Message):
    ...
    capy = f"""
** ⌔ الاسم :** [{thum}]({mo})
** ⌔ بطلب الكائن دا :** {message.from_user.mention}
"""
...
async def vsong(client, message: Message):
    ...
    pablo = await client.send_message(message.chat.id, f"** ⌔ اسم اغنيتك :** `{urlissed}`")
    if not urlissed:
        await pablo.edit(
            "⌔ اكتب اسم اغنيه او ارجع لزر الاوامر لمعرفة استخدامي."
        )
        return
    ...
    capy = f"""
** ⌔ الاسم :** [{thum}]({mo})
** ⌔ طلب الكائن دا :** {message.from_user.mention}
"""
